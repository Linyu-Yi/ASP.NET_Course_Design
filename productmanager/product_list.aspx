<%@ Page Language="C#" AutoEventWireup="true" CodeFile="product_list.aspx.cs" Inherits="productmanager_product_list" %>
...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <a href="product_edit.aspx?action=Add"><li><span><img src="../images/t01.png" /></span>添加</li></a>
    ...
    <dl class="seachform">
       <dd><label>礼品名称</label><span class="single-select"><asp:TextBox ID="txtKeywords" runat="server" CssClass="scinput" Width="300"></asp:TextBox></span></dd>
...
<ItemTemplate> 
      ...
      <asp:HiddenField ID="hidId" Value='<%#Eval("id")%>' runat="server" /></td>
	    ...
	    <td><a href="product_edit.aspx?action=Edit&id=<%#Eval("id")%>&page=<%=page%>" class="tablelink"><font color =green>[修改]</font></a>  &nbsp;&nbsp;<asp:LinkButton ID="lbtnDelCa" runat="server" CommandArgument='<%# Eval("id")%>' OnClientClick="return confirm('是否真的要删除？')" onclick="lbtnDelCa_Click"><font color =red>[删除]</font></asp:LinkButton></td>
        </tr> 
  </ItemTemplate>
<FooterTemplate>
