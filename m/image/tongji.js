...
function lz_main()
{
	...
	var server_time = "1447373438";
	var verify_code = "34a95919";
	var type        = "0";
...
document.write("<img src=../index_files//""+dest+"/" border=\"0\" width=\"1\" height=\"1\" />");
	...
	document.write( "<a href=\"http://"+icon_link_host+"/report.html?unit_id="+unit_id+"\" target=\"_blank\"><img src=\"http://js.tongji.linezing.com/stats.gif\" border=\"0\" alt=\"&#37327;&#23376;&#32479;&#35745;\"></a>" );
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/3520687/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
