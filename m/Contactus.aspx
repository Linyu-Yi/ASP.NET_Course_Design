<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Contactus.aspx.cs" Inherits="m_Contactus" %>
...
<body>
   ...
   <nav><a href="javascript:history.go(-1)" class="black"><b></b></a>联系客服<a href="index.aspx" class="house right_house"><s></s></a></nav>
		 <div id="main"> 	
		    <div class="addres networkdiv contactdiv">
		    	<p class="btncontact">联系方式</p>
		    	 <asp:Literal ID="LitContactus" runat="server"></asp:Literal>
		    </div>
		     <div class="dizhi networkdiv contactdiv">
		    	<p class="btncontact">我们位置</p>
		    	 <p>   <!--引用百度地图API-->
<style type="text/css"> 
...
<script type="text/javascript" src="http://api.map.baidu.com/api?key=&v=1.1&services=true"></script>
 <div style="width:98%;height:200px;border:#ccc solid 1px;" id="dituContent"></div>
