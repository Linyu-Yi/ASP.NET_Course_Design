<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sellnet_edit.aspx.cs" Inherits="sysmanager_sellnet_edit" %>
...
<body>
    ...
    <li><a href="sellnet_list.aspx">销售网点管理</a></li>
    <li><a href="#">编辑销售网点</a></li>
    </ul>
    </div>
    
        <div class="formbody">   
    <div class="formtitle"><span>销售网点信息</span></div>
    <!--/帮助中心信息信息-->
<div class="tab-content">
 ...
 <dl>
    ...
    <dd><asp:TextBox ID="txttitle" runat="server" Width="600" CssClass="input normal" datatype="*2-100" sucmsg=" " />
      <span class="Validform_checktip">*销售网点名称最多100个字符</span>
      </dd>
  </dl> 
    ...
    <dd>
      ...
      <div class="upload-box upload-img"></div>  <span class="Validform_checktip">*请上传销售网点图片</span> 
    </dd>
  </dl>
    <dl>
    <dt>销售网点内容</dt>
