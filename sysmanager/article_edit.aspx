<%@ Page Language="C#" AutoEventWireup="true" CodeFile="article_edit.aspx.cs" Inherits="sysmanager_article_edit" %>
...
<body>
    ...
    <li><a href="article_list.aspx">帮助中心管理</a></li>
    <li><a href="#">编辑帮助中心</a></li>
    </ul>
    </div>
    
        <div class="formbody">   
    <div class="formtitle"><span>帮助中心信息</span></div>
    <!--/帮助中心信息-->
<div class="tab-content">
 ...
 <dl>
    ...
    <dd><asp:TextBox ID="txttitle" runat="server" Width="600" CssClass="input normal" datatype="*2-100" sucmsg=" " />
      <span class="Validform_checktip">*帮助中心信息标题最多100个字符</span>
      </dd>
  </dl> 
    <dl>
    <dt>内容</dt>
  ...
  <dl >
    ...
    <dd>
      ...
      <span class="Validform_checktip">*不显示该帮助中心信息在系统首页不在显示</span>
    </dd>
  </dl>
  <dl>
    <dt>排序数字</dt>
