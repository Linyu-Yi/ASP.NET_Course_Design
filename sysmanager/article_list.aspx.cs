...
public partial class sysmanager_article_list : ManagePage
{
    ...
    { 
        //检查权限
        if (ChkAdminLevel(this.Page, 31, "Delete"))
        {
            // 当前点击的按钮
            ...
            bll.Delete(caId);
            AddAdminLog("删除", "删除帮助中心信息：" + title + ""); //记录日志
            JscriptMsg(this.Page, " 成功删除帮助中心信息：" + title + "", Utils.CombUrlTxt("article_list.aspx", "keywords={0}&page={1}", this.keywords, this.page.ToString()), "Success");
        }
    }
    ...
    { 
        ...
        if (ChkAdminLevel(this.Page, 31, "Delete"))
        {
            ...
            AddAdminLog("删除", "删除帮助中心信息成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
            JscriptMsg(this.Page, " 删除帮助中心信息成功" + sucCount + "条，失败" + errorCount + "条", Utils.CombUrlTxt("article_list.aspx", "keywords={0}&page={1}", this.keywords, this.page.ToString()), "Success");
        }
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        JscriptMsg(this.Page, " 排序保存成功", Utils.CombUrlTxt("article_list.aspx", "keywords={0}&page={1}", this.keywords, this.page.ToString()), "Success"); 
    }
}
