<%@ Page Language="C#" AutoEventWireup="true" CodeFile="depot_category_edit.aspx.cs" Inherits="sysmanager_depot_category_edit" %>
...
<body>
    ...
    <li><a href="depot_category_list.aspx">发货仓库管理</a></li>
    <li><a href="#">编辑发货仓库</a></li>
    </ul>
    </div>

    <div class="formbody">   
    <div class="formtitle"><span>发货仓库信息</span></div>
    <!--/发货仓库信息-->
