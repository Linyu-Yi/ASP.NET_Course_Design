<%@ Page Language="C#" AutoEventWireup="true" CodeFile="magic_edit.aspx.cs" Inherits="sysmanager_magic_edit" %>
...
<body>
    ...
    <li><a href="magic_list.aspx">轮播图管理</a></li>
    <li><a href="#">编辑轮播图</a></li>
    </ul>
    </div>
    
        <div class="formbody">   
    <div class="formtitle"><span>轮播图信息</span></div>
    <!--/帮助中心信息信息-->
<div class="tab-content">
 ...
 <dl>
    ...
    <dd><asp:TextBox ID="txttitle" runat="server" Width="600" CssClass="input normal" datatype="*2-100" sucmsg=" " />
      <span class="Validform_checktip">*轮播图名称最多100个字符</span>
      </dd>
  </dl> 
    ...
    <dd>
      ...
      <div class="upload-box upload-img"></div>  <span class="Validform_checktip">*请上传轮播图图片</span> <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtImgUrl"
