<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manager_rep.aspx.cs" Inherits="sysmanager_manager_rep" %>
        ...
        <ItemTemplate>
         <tr bgcolor="#FFFFFF" >
            ...
            <td align="left" style="vnd.ms-excel.numberformat:@" ><%# Eval("user_name")%></td>
             ...
             <td align="center"><%#new ax_manager_role().GetTitle(Convert.ToInt32(Eval("role_id")))%></td>                
