...
public partial class sysmanager_magic_edit : ManagePage
{
    protected int page;
    ...
    private bool DoAdd()
    {
        ...
        if (model.Add() > 0)
        {
            AddAdminLog("添加", "添加轮播图：" + txttitle.Text); //记录日志
            return true;
        }
    ...
    private bool DoEdit(int _id)
    {
        ...
        if (model.Update())
        {
            AddAdminLog("修改", "修改轮播图:" + txttitle.Text); //记录日志
            result = true;
        }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (action == "Edit") //修改
        {
            ...
            if (ChkAdminLevel(this.Page, 41, "Edit"))
            {
                ...
                JscriptMsg(this.Page, "修改轮播图成功！", Utils.CombUrlTxt("magic_list.aspx", "page={0}", this.page.ToString()), "Success");
            }
        }
        else //添加
        {
            ...
            if (ChkAdminLevel(this.Page, 41, "Add"))
            {
                ...
                JscriptMsg(this.Page, "添加轮播图成功！", "magic_list.aspx", "Success");
            }
        }
    }
}