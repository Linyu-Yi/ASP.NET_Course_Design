<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ticket_inset.aspx.cs" Inherits="ticketmanager_ticket_inset" %>
...
<body>
    ...
    <li><a href="#">批量生成礼券</a></li>
    </ul>
    </div>

    <div class="formbody">   
    <div class="formtitle"><span>批量生成礼券</span></div>
    <!--/礼券信息-->
<div class="tab-content">
  ...
  <dl>
    <dt>该所选礼券规格生成</dt>
    <dd><asp:TextBox ID="txtticket_num" runat="server" CssClass="input small" datatype="n" MaxLength="6"  sucmsg=" " ></asp:TextBox> &nbsp;张 <span class="Validform_checktip">*</span></dd>
  </dl> 
