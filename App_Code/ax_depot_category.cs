...
using System.Data.SqlClient;
	...
	/// </summary>
	[Serializable]
	public partial class ax_depot_category
	{
		public ax_depot_category()
		{}
        #region Model
        private int _id;
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from [ax_depot_category]");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 title from [ax_depot_category]");
            strSql.Append(" where id=" + id);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into [ax_depot_category] (");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update [ax_depot_category] set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from [ax_depot_category] ");
            strSql.Append(" where id=@id ");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        public void GetModel(int id)
        {
            ...
            strSql.Append(" FROM [ax_depot_category] ");
            strSql.Append(" where id=@id ");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update ax_depot_category set " + strValue);
            strSql.Append(" where id=" + id);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from ax_depot_category");
            if (category_id == 0)
            {
