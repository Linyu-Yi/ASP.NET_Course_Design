...
using System.Data.SqlClient;
	...
	/// </summary>
	[Serializable]
	public partial class ax_manager_log
	{
		public ax_manager_log()
		{}
		#region Model
		private long _id;
		...
		public bool Exists(long id)
		{
			...
			strSql.Append("select count(1) from [ax_manager_log]");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [ax_manager_log] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [ax_manager_log] set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [ax_manager_log] ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.BigInt)};
			parameters[0].Value = id;
		...
		public void GetModel(long id)
		{
			...
			strSql.Append(" FROM [ax_manager_log] ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.BigInt)};
			parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM  ax_manager_log");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
