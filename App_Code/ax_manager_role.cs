...
using System.Collections.Generic;
	...
	/// </summary>
	[Serializable]
	public partial class ax_manager_role
	{
		public ax_manager_role()
		{}
		#region Model
		private int _id;
        ...
        private List<ax_manager_role_value> _manager_role_values;
        /// <summary>
        /// 权限子类 
        /// </summary>
        public List<ax_manager_role_value> manager_role_values
        {
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from [ax_manager_role]");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [ax_manager_role] (");
            ...
            if (manager_role_values != null)
            {
                foreach (ax_manager_role_value modelt in manager_role_values)
                {
                    strSql2 = new StringBuilder();
                    strSql2.Append("insert into ax_manager_role_value(");
                    strSql2.Append("role_id,nav_id,action_type)");
                    ...
                    parameters2[1].Value = modelt.nav_id;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [ax_manager_role] set ");
            ...
            strSql2.Append("delete from ax_manager_role_value where role_id=@role_id ");
            SqlParameter[] parameters2 = {
					new SqlParameter("@role_id", SqlDbType.Int,4)};
            ...
            if (manager_role_values != null)
            {
                ...
                foreach (ax_manager_role_value modelt in manager_role_values)
                {
                    ...
                    strSql3.Append("insert into ax_manager_role_value(");
                    strSql3.Append("role_id,nav_id,action_type)");
                    ...
                    parameters3[1].Value = modelt.nav_id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update ax_manager_role set " + strValue);
            strSql.Append(" where id=" + id);
		...
		public bool Delete(int id)
        {
            ...
            //删除管理角色
            StringBuilder strSql2 = new StringBuilder();
            strSql2.Append("delete from ax_manager_role ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 role_name from [ax_manager_role]");
            strSql.Append(" where id=" + id);
