...
using System.Data.SqlClient;
	...
	/// </summary>
	[Serializable]
	public partial class ax_article
	{
		public ax_article()
		{}
        #region Model
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from [ax_article]");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select top 1 title from [ax_article]");
            strSql.Append(" where id=" + id);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into [ax_article] (");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update [ax_article] set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update ax_article set " + strValue);
            strSql.Append(" where id=" + id);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from [ax_article] ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
			parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM  ax_article");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
